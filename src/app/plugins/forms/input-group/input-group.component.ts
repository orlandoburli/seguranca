import { Component, OnInit, Input, Output, Host, EventEmitter, forwardRef, ElementRef, AfterContentChecked, AfterContentInit } from '@angular/core';
...
export class InputGroupComponent implements OnInit, ControlValueAccessor, AfterContentChecked {
